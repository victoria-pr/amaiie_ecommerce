...
const data = {
  users: [
    ...
    },
    {
      ...
      password: bcrypt.hashSync("123"),
      description:
        "Vicky es una talentosa artista de 31 años con una pasión innata por las manualidades. Su creatividad y habilidades artísticas le permiten crear piezas únicas y diferentes que cautivan a todos los que las ven. Con su dedicación y amor por su oficio, se ha convertido en una exitosa emprendedora en el mundo de las manualidades.  Desde temprana edad, Vicky mostró un gran interés por las artes y la creación. Siempre estaba experimentando con diferentes materiales y técnicas, explorando nuevas formas de expresar su imaginación. A lo largo de los años, ha perfeccionado su técnica y ha desarrollado un estilo distintivo que combina elementos tradicionales y contemporáneos.  Vicky se especializa en la creación de manualidades únicas que tienen un enfoque moderno y estético. Utiliza una amplia variedad de materiales, desde papel y tela hasta arcilla y metales, para crear piezas verdaderamente sorprendentes. Sus obras abarcan desde joyería artesanal y accesorios hasta decoración del hogar y regalos personalizados.",
      isAdmin: false,
      isArtist: true,
    },
  ],
