...
export default function ProductEditScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`https://api.amaiie.lafuentedanel.com/api/products/${productId}`);
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(`https://api.amaiie.lafuentedanel.com/api/products/${productId}`, formData, {
        headers: {
